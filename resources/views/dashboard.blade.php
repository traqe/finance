    ...
    <div class="col-lg-4">
        <div class="card card-chart">
            <div class="card-header">
                ...
                <h3 class="card-title"><i class="tim-icons icon-money-coins text-primary"></i>{{$currency->sign}}{{ ($semesterincomes) * $currency->index }}</h3>
            </div>
            <div class="card-body">
                <div class="chart-area">
    ...
    <div class="col-lg-4">
        <div class="card card-chart">
            <div class="card-header">
                ...
                <h3 class="card-title"><i class="tim-icons icon-bank text-info"></i> {{$currency->sign}}{{ ($monthlybalance) * $currency->index }}</h3>
            </div>
            <div class="card-body">
                <div class="chart-area">
    ...
    <div class="col-lg-4">
        <div class="card card-chart">
            <div class="card-header">
                ...
                <h3 class="card-title"><i class="tim-icons icon-paper text-success"></i> {{ $currency->sign }}{{ ($semesterexpenses) * $currency->index }}</h3>
            </div>
            <div class="card-body">
                <div class="chart-area">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$currency->sign}}{{ ($sale->transactions->sum('amount')) * $currency->index }}</td>
                                <td>{{$currency->sign}}{{ ($sale->products->sum('total_amount')) * $currency->index }}</td>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$currency->sign}}{{ ($transaction->amount) * $currency->index }}</td>
                                <td class="td-actions text-right">
